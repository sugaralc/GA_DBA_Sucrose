...
def Glcyl():
    ...
    if ph_subs == 'meta':
        ...
        PBA_meta=[['C-O-C1=CC=C(-[96*])C=C1-[98*]', 9.0,-1], # 2-Methoxyphenylboronic acid DOI:10.1016/j.tet.2004.08.051
        ...
        #print("meta",index,Chem.MolFromSmiles(PBA_mol))
    ...
    if ph_subs == 'ortho':
        ...
        #print("ortho",Chem.MolFromSmiles(PBA_mol))
        return Chem.MolFromSmiles(PBA_mol), str(pKa)
    ...
    if ph_subs == 'para':
        ...
        #print("para",Chem.MolFromSmiles(PBA_mol))
        return Chem.MolFromSmiles(PBA_mol), str(pKa)
...
def Frcyl():
    ...
    if ph_subs == 'meta':
        ...
        PBA_meta=[['C-O-C1=CC=C(-[97*])C=C1-[99*]', 9.0,-1], # 2-Methoxyphenylboronic acid DOI:10.1016/j.tet.2004.08.051
        ...
        #['C-[NH+](-C)-C-C1=CC=C(-[97*])C=C1-[99*]', 5.3,-1], # 2-Dimethylaminomethylphenylboronic acid (DAPBA) DOI:10.1016/j.tet.2004.08.051
        ['[99*]-C1C(-C[NH+](C)C)=CC(-[97*])=CC1', 5.3,-1], # 2-Dimethylaminomethylphenylboronic acid (DAPBA) DOI:10.1016/j.tet.2004.08.051
