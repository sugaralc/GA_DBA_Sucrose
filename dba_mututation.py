...
import mutate4DBA as mu
import PBA_mutation as PBA_mu
import os

DBA_mutation_dir = os.path.dirname(__file__)
molgpka_src_dir = os.path.join(DBA_mutation_dir,"MolGpKa/src")
#sys.path.insert(1,'MolGpKa/src')
sys.path.append(molgpka_src_dir)
from MolGpKa.src import protonate
#print("From DBA_mutation:",protonate.__path__)
...
if __name__ == "__main__":
    ...
    mutated_child = DBA_mutation(mol1,idx_glcyl,glcylpatt,idx_frcyl,frcylpatt)
